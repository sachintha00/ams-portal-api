                                                            ...
                                                            <table cellpadding="0" cellspacing="0" width="100%"
                                                                ...
                                                                <tr>
                                                                    <td align="center"
                                                                        ...
                                                                        <img src="https://fbyhhlb.stripocdn.email/content/guids/CABINET_907ff212b3b3bdba48a051ed93375cc4fc7345c7089a7662bec001a066378ea9/images/oip.jpg"
                                                                            alt="Logo"
                                                                            style="display:block;font-size:12px;border:0;outline:none;text-decoration:none"
                                                                            width="200" title="Logo" class="adapt-img">
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                                ...
                                                                <tr>
                                                                    <td align="center" class="es-m-p0r es-m-p0l"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            novelties, discounts, sales, new and
                                                                            seasonal collections, as well as events and
                                                                            news!</p>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" width="100%"
                                                                ...
                                                                <tr>
                                                                    <td align="center" class="es-m-txt-c"
                                                                        ...
                                                                        <h2
                                                                            style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:30px;font-style:normal;font-weight:bolder;line-height:31px;color:#333333">
                                                                            Hello !!</h2>
                                                                        <h2
                                                                            ...
                                                                            Your Verification code is {{$token}}</h2>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="center" class="es-m-txt-c"
                                                                        ...
                                                                        <h1
                                                                            style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:46px;font-style:normal;font-weight:bold;line-height:55px;color:#666666">
                                                                        ...
                                                                        <table cellpadding="0" cellspacing="0"
                                                                            ...
                                                                            <tr>
                                                                                <td align="center" valign="top"
                                                                                    ...
                                                                                    <img title="Facebook"
                                                                                        src="https://fbyhhlb.stripocdn.email/content/assets/img/social-icons/logo-black/facebook-logo-black.png"
                                                                                        alt="Fb" width="32"
                                                                                ...
                                                                                <td align="center" valign="top"
                                                                                    ...
                                                                                    style="padding:0;Margin:0;padding-right:40px">
                                                                                    <img title="Instagram"
                                                                                        src="https://fbyhhlb.stripocdn.email/content/assets/img/social-icons/logo-black/instagram-logo-black.png"
                                                                                        alt="Inst" width="32"
                                                                                        style="display:block;font-size:14px;border:0;outline:none;text-decoration:none">
                                                                                </td>
                                                                                <td align="center" valign="top"
                                                                                    style="padding:0;Margin:0"><img
                                                                                        title="Youtube"
                                                                                        src="https://fbyhhlb.stripocdn.email/content/assets/img/social-icons/logo-black/youtube-logo-black.png"
                                                                                        alt="Yt" width="32"
                                                                                        style="display:block;font-size:14px;border:0;outline:none;text-decoration:none">
                                                                                </td>
                                                                            </tr>
