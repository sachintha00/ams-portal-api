...
return new class extends Migration
{
    ...
    {
        $procedure = <<<SQL
                CREATE OR REPLACE PROCEDURE STORE_PROCEDURE_WORKFLOW_REQUEST_APPROVED(
                ...
                BEGIN
                    ...
                    SET approver_user_id = p_approver_user_id,
                        ...
                        request_status_from_level = 'APPROVED',
                        updated_at = NOW()
                    ...
                    ELSE
                        TRUNCATE TABLE response;
                        INSERT INTO response (status, message)
                        VALUES ('SUCCESS', 'Approved successfully');
                    END IF;
    ...
    {
        DB::unprepared('DROP PROCEDURE IF EXISTS STORE_PROCEDURE_WORKFLOW_REQUEST_APPROVED');
    }
};